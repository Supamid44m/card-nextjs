...
function Profile() {
  ...
  return (
    <>
      ...
      <div className='bg-white  rounded-2xl flex items-center max-w-md mx-auto mt-10 shadow  border-0 p-3 relative'>
      ...
      <div className="">
        ...
        <div className='grid grid-cols-4 gap-y-4 mb-10 place-items-center mt-2'>
          {filteredProfile.map((item, index) => (
            <div
              key={index}
              className="block rounded-2xl bg-white hover:bg-slate-300 relative shadow-md ml-2 mr-2 h-96 w-4/5  "
            >
              <div className="absolute inset-x-0 top-0 w-full h-20 bg-gradient-to-b from-indigo-500 rounded-t-2xl">
              </div>
              ...
              <div className='relative ml-2'>
                {item.address.coordinates.lat > 2 ? (
                  <>
                    <div className='mb-2 mt-2'>
                      ...
                      <span className='flex items-center'>
                        <BiSolidShieldAlt2 />
                        <span className='pl-2'>Guild</span>
                      </span>
                      ...
                      <div className='ml-4'>
                        ...
                        <Popup trigger={<button><span className='text-xs ml-2 border border-indigo-600 rounded-full hover:bg-indigo-800 hover:text-white'>...</span></button>}
                          position="top center">
                          <div className='bg-white flex flex-col my-2 w-40 border border-indigo-600 rounded-md'>
                            <span className='text-xs border border-indigo-600 rounded-full h-5 px-2 py-a my-2 mx-2 hover:bg-indigo-800 w-28 hover:text-white'>{item.gender}</span>
                  ...
                  <>
                    <span className='text-l pt-2 flex items-center '>
                      <BiSolidShieldAlt2 />
                      <span className='pl-2'>Guild</span>
                    </span>
                    <div className='ml-4'>
